"""
Script to get data from a sensor from BD

Usage : fetchASensor.py BD_API_KEY room sensor StartYYYY StartMM StartDD EndYYYY EndMM EndDD

Based on code from Hidutoshi
...
if __name__ == "__main__":
    BD_DATAS_API_KEY = sys.argv[1]; 
    start = parser.parse(datetime(sys.argv[4],sys.argv[5],sys.argv[6],0,0,tzinfo=tzlocal()).isoformat())
    end = parser.parse(datetime(sys.argv[7],sys.argv[8],sys.argv[9],0,0,tzinfo=tzlocal()).isoformat())
